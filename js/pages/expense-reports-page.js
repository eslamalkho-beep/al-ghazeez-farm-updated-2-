...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  _allExpensesForReport = await getAllExpenses();
  _expenseCategoriesForReport = await getCategoryNames('expense');
  ...
  document.getElementById('export-excel-btn').addEventListener('click', () => {
    const title = _reportMode === 'period' ? 'تقرير المصروفات حسب البند' : 'مقارنة المصروفات بين فترتين';
